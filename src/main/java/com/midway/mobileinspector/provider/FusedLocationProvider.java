...
import com.midway.mobileinspector.listener.MultiLocationListener;
...
public final class FusedLocationProvider implements LocationProvider {
     ...
     */
    private static final int LOCATION_ACCURACY = 15; //20;                         // meters
     ...
     */
    private static final long NETWORK_MIN_TIME_UPDATE = 20000; //5000;                          // [s]
    /**
     ...
     */
    private static final long GPS_MIN_TIME_UPDATE = 20000; //1000;                           // 1000 * 5 * 1 [ms]
